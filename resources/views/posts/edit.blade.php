                    ...
                    <div class="card-body">
                        <form method="POST" action="/blog/{{ $post->id }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" hidden name="id" value="{{ Auth::user()->id }}" required autocomplete="id" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="content" type="text" rows="5" style="resize:none" class="form-control @error('content') is-invalid @enderror" name="content" value="{{$post->content}}" required autocomplete="content">{{$post->content}}</textarea>
                            ...
                            <div class="row mb-3">
                                <label for="image" class="col-md-4 col-form-label text-md-end">Add New Image</label>
