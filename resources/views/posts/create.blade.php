<div id="formContent" class="position-fixed d-none fixed-top d-flex w-100 d-flex justify-content-around align-items-center" style="height:100%; z-index:100">
    
    <div class="container position-relative bg-dark py-5" id="formCreate">
          <h1 class="position-absolute mx-5 mt-4 top-0 start-0 text-light">Create Post</h1>
          <button onClick="closecontent()" class="btn btn-primary position-absolute mx-5 mt-4 top-0  end-0 text-light">Close</button>
                    ...
                    <div class="card-body">
                        <form method="POST" action="/blog" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea id="content" type="text" rows="5" style="resize:none" class="form-control @error('content') is-invalid @enderror" name="content" value="{{ old('content') }}" required autocomplete="content"></textarea>
